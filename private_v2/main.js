...
function SEND(request, data, status = 200, headers = {}) {
  // grab whatever Origin the browser sent (or null if absent)
  const origin = request.headers.get('Origin');
  // if there *is* an Origin header, echo it back; otherwise fall back to "*"
  ...
  const corsHeaders = {
    ...
    // if you ever switch to using credentials, you'll need:
