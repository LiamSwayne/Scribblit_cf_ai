...
- startTime: In HH:mm format (24-hour). Only for events. If a time is stated but doesn't state AM or PM use reasoning to infer AM or PM. If the start time cannot be figured out omit this field rather than making a guess. Do not use the current time as a default start time for an event unless the user says it is starting now.
