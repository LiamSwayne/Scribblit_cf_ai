...
- startTime: In HH:mm format (24-hour). Only for events. Use reasoning and context of the current time to guess AM/PM when not explicitly stated. If a start time cannot be inferred do not include this field. Do not use the current time as a default start time for an event.
