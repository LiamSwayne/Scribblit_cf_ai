...
export default {
    async fetch(request, env) {
        ...
        - name: The name formatted to sentence case like "Bursh teeth", not "Brush Teeth". The input you are given is written very hastily, so expand shorthand like "HW" to the full term like "Homework". Don't expand acronyms. Remove words from the name that provide no value, like "due". The name you produce shouldn't remove any details from the input.
